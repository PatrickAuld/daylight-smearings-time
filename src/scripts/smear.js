...
export const SMEAR = 14 * DAY;
export const SMEAR_RATE = "2.98 ms/s";
...
export function smearState(now) {
...
export const fmtDate = d => d.toLocaleDateString(undefined,
